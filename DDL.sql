...
CREATE TABLE Products (
    ...
    FOREIGN KEY (productTypeCode) REFERENCES ProductTypes(productTypeCode) ON DELETE CASCADE
);
...
VALUES ('Leopard Gecko', 2, 149.99, 0, 1),
('Bearded Dragon', 1, 199.99, 0, 3),
('Corn Snake', 3, 129.99, 1, NULL);
